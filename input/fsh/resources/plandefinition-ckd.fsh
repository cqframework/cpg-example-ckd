...
Usage: #example
* url = "http://hl7.org/fhir/uv/cpg/PlanDefinition/cc-cpg-plan-ckd"
* version = "1.0.1"
* name = "ChronicKidneyDiseaseAmbulatory"
* title = "Chronic Kidney Disease - Ambulatory"
...
* action[0]
  ...
  * action
    ...
    * documentation
      ...
      * citation = "Chronic Kidney Disease Clinical Overview. ClinicalKey. Source"
      * url = "http://himss19.ordersetsmanager.com/evidenceviewer/#/7CBBBE9B75E10232E05352E3610A5325/7CBBBE9B75E80232E05352E3610A5325"
...
* action[+]
  ...
  * action
    ...
    * documentation
      ...
      * url = "http://himss19.ordersetsmanager.com/evidenceviewer/#/7CBBBE9B75E10232E05352E3610A5325/7CBBBE9B75ED0232E05352E3610A5325"
    * groupingBehavior = #visual-group
    * action[0]
      ...
      * requiredBehavior = #could
      * precheckBehavior = #no
      * definitionCanonical = "http://hl7.org/fhir/uv/cpg/ActivityDefinition/cc-cpg-activity-edu-hypertension"
    * action[+]
      ...
      * requiredBehavior = #could
      * precheckBehavior = #no
      * definitionCanonical = "http://hl7.org/fhir/uv/cpg/ActivityDefinition/cc-cpg-activity-edu-renal-diet"
* action[+]
  * id = "34387251"
  * title = "Medications"
  * documentation
  ...
  * action[0]
    ...
    * documentation
      ...
      * url = "http://himss19.ordersetsmanager.com/evidenceviewer/#/7CBBBE9B75E10232E05352E3610A5325/7CBBBE9B75FA0232E05352E3610A5325"
    * groupingBehavior = #visual-group
    * action[0]
      * id = "34387257"
  ...
  * action[+]
    ...
    * documentation
      ...
      * citation = "Kidney Disease: Improving Global Outcomes (KDIGO) Blood Pressure Work Group. KDIGO clinical practice guideline for the management of blood pressure in chronic kidney disease. Kidney Int. 2012;2 (Suppl), 337-414. Source"
      * url = "http://himss19.ordersetsmanager.com/evidenceviewer/#/7CBBBE9B75E10232E05352E3610A5325/7CBBBE9B76030232E05352E3610A5325"
    * groupingBehavior = #visual-group
    * action
      * id = "34387266"
...
* action[+]
  ...
  * action[0]
    ...
    * documentation
      ...
      * url = "http://himss19.ordersetsmanager.com/evidenceviewer/#/7CBBBE9B75E10232E05352E3610A5325/7CBBBE9B761A0232E05352E3610A5325"
    * groupingBehavior = #visual-group
    * action
      ...
      * requiredBehavior = #could
      * precheckBehavior = #no
      * definitionCanonical = "http://hl7.org/fhir/uv/cpg/ActivityDefinition/cc-cpg-activity-lab-metabolic"
  * action[+]
    * id = "34387206"
    * title = "Urine"
    * documentation
      ...
      * url = "http://himss19.ordersetsmanager.com/evidenceviewer/#/7CBBBE9B75E10232E05352E3610A5325/7CBBBE9B75C80232E05352E3610A5325"
    * groupingBehavior = #visual-group
    * action
      ...
      * requiredBehavior = #could
      * precheckBehavior = #no
      * definitionCanonical = "http://hl7.org/fhir/uv/cpg/ActivityDefinition/cc-cpg-activity-lab-creatinine"
* action[+]
  * id = "34387217"
  * title = "Radiology"
  * groupingBehavior = #visual-group
  * action
    ...
    * action
      ...
      * requiredBehavior = #could
      * precheckBehavior = #no
      * definitionCanonical = "http://hl7.org/fhir/uv/cpg/ActivityDefinition/cc-cpg-activity-ultrasound-renal"
* action[+]
  ...
  * action[0]
    ...
    * requiredBehavior = #could
    * precheckBehavior = #no
    * definitionCanonical = "http://hl7.org/fhir/uv/cpg/ActivityDefinition/cc-cpg-activity-referral-nephrology"
  * action[+]
    ...
    * requiredBehavior = #could
    * precheckBehavior = #no
    * definitionCanonical = "http://hl7.org/fhir/uv/cpg/ActivityDefinition/cc-cpg-activity-referral-dietition"